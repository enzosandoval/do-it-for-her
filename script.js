document.addEventListener('DOMContentLoaded', function() {
    ...
        { src: "images/chisato7.jpg", top: "10%", left: "26.3%", width: "5.6%", rotate: 0 }, 
        { src: "images/chisato1.jpg", top: "14%", right: "75%", width: "6%", rotate: 0 }, 
        { src: "images/chisato4.jpg", top: "10%", right: "-5.5%", width: "26%", rotate: 0}, 
    ...
        { src: "images/chisato6.gif", top: "60%", left: "35%", width: "42%", rotate: 0 },
    ...
    if (isPlaying) {
        ...
        audio.play()
            ...
            .catch(error => {
                ...
                alert("Error al cargar el archivo de audio. Verifica que el archivo esté en la carpeta 'files'");
            });
    }
    isPlaying = !isPlaying;
};
